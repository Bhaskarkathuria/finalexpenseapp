...
function onlogin(e) {
  e.preventDefault();
  axios
    .post("http://13.53.205.107:5000/login", {
      email: email.value,
    ...
    .then((res) => {
      ...
      location.replace("http://13.53.205.107:5000/inapp-features/index.html");
    })
    .catch((err) => {
...
function showform(e) {
  ...
  submit.addEventListener("click", (e) => {
    axios.post("http://13.53.205.107:5000/passwordrequest/forgot", {
