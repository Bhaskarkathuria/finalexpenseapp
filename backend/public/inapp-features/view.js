...
function onsubmit(e) {
  ...
  axios
    .post(
      "http://13.53.205.107:5000/expenses",
      {
...
function deleterow(e) {
  ...
  axios
    .delete(
      `http://13.53.205.107:5000/expenses/${e.target.parentElement.parentElement.id}`,
      {
        headers: { Authorization: token },
      }
    )
...
function loadExpense() {
  ...
  axios
    .get(
      `http://13.53.205.107:5000/expenses?page=${page}&limit=${localStorage.getItem(
        "limit"
      )}`,
      {
        headers: { Authorization: token },
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (isPremiumUser === true) {
    ...
    download.addEventListener("click", (e) => {
      e.preventDefault();
      axios
        .get("http://13.53.205.107:5000/expenses/download", {
          headers: { Authorization: token },
        })
        .then((result) => {
    ...
    leaderboard.addEventListener("click", (e) => {
      ...
      const token = localStorage.getItem("token");
      axios
        .get("http://13.53.205.107:5000/premiumfeatures", {
          headers: { Authorization: token },
        })
        .then((response) => {
...
function getpayment(e) {
  ...
  console.log(token);
  axios
    .get("http://13.53.205.107:5000/purchasePremium", {
      headers: { Authorization: token },
    })
    .then((response) => {
      ...
      var options = {
        ...
        handler: async function (response) {
          await axios
            .post(
              "http://13.53.205.107:5000/trasactionstatus",
              {
